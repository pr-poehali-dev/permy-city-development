...
const HERO_IMAGE = "https://cdn.poehali.dev/projects/92bc8372-686f-4df8-beaa-5a8de6eb286a/files/ea64798c-9877-4bd0-b481-92b22c02bafd.jpg";
...
const NEWS = [
  ...
  },
  {
    ...
    excerpt: "По итогам открытого архитектурного конкурса выбран проект благоустройства центральной набережной — пешеходный бульвар длиной 1,2 км.",
    icon: "Award",
  },
];
...
const STATS = [
  { value: "42 га", label: "Площадь территории" },
  { value: "18", label: "Жилых корпусов" },
  { value: "4 800", label: "Квартир" },
  { value: "2028", label: "Год сдачи" },
];
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <div className="animate-slide-up">
            ...
            <div className="space-y-5 font-ibm text-muted-foreground leading-relaxed">
              <p>
                Пермь-Сити — комплексный проект реновации промышленной территории
                в Орджоникидзевском районе города. На месте устаревших производственных
                объектов возникнет современный многофункциональный квартал.
              </p>
              <p>
                Концепция разработана с учётом принципов устойчивого развития:
                максимальная пешеходная связность, развитая зелёная инфраструктура
                и комфортная городская среда для всех категорий жителей.
              </p>
              <p>
                В составе квартала — жилые башни высотой от 18 до 32 этажей,
                коммерческие площади, образовательные учреждения,
                детские сады и медицинский центр.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-px">
            {[
              { label: "Застройщик", value: "ООО «Пермь-Сити Девелопмент»" },
              { label: "Генеральный проектировщик", value: "АО «Уралпроект»" },
              { label: "Генеральный подрядчик", value: "ООО «СтройГрупп»" },
              { label: "Общая площадь застройки", value: "420 000 м²" },
              { label: "Жилая площадь", value: "298 500 м²" },
              { label: "Коммерческая площадь", value: "54 000 м²" },
              { label: "Начало строительства", value: "I квартал 2024" },
              { label: "Плановая сдача", value: "IV квартал 2028" },
            ].map((row) => (
              <div
                key={row.label}
