        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <div className="animate-slide-up">
            ...
            <div className="space-y-5 font-ibm text-muted-foreground leading-relaxed">
              <p>
                Пермь-Сити — современный жилой и деловой комплекс в городе Перми,
                расположенный на участке площадью 2,6 гектара. Проект реализуется
                в рамках комплексного развития городской территории.
              </p>
              <p>
                Концепция разработана с учётом современных стандартов комфортной
                городской среды: эргономичные планировки, развитая инфраструктура
                и благоустроенные общественные пространства на территории комплекса.
              </p>
              <p>
                В составе проекта — жилые корпуса, коммерческие площади
                первых этажей, подземный паркинг и благоустроенный двор
                без автомобилей для жителей всех возрастов.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-px">
            {[
              ...
              { label: "Жилая площадь", value: "уточняется" },
              { label: "Коммерческая площадь", value: "уточняется" },
